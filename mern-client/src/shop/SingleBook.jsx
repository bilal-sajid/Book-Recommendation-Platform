...
const SingleBook = () => {
  ...
  const { _id, title, imageURL, description, authorName, uploadedBy, pdfURL} = useLoaderData();
  ...
  return (
    ...
    <div className="mt-28 mx-4 my-8 lg:mx-24 flex flex-col lg:flex-row items-start">
      ...
      <div className="lg:w-2/3 mx-auto p-6 bg-white">
        ...
        <p className="text-2xl font-semibold text-gray-600 mb-10">{authorName}</p>
        <p className="text-2xl font-semibold text-blue-700 mb-4">Why {uploadedBy} Recommends it:</p>
